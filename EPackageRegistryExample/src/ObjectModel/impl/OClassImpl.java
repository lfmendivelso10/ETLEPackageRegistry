 ...
 * </p>
 * <ul>
 *   <li>{@link ObjectModel.impl.OClassImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OClassImpl extends MinimalEObjectImpl.Container implements OClass {
	...
	protected EClass eStaticClass() {
		return ObjectModelPackage.Literals.OCLASS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ObjectModelPackage.OCLASS__NAME, oldName, name));
	}
