...
/**
 * This is the item provider adapter for a {@link ComponentModel.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDependOfPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComponentModelPackage.Literals.DEPENDENCY__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Depend Of feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDependOfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_dependOf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_dependOf_feature", "_UI_Dependency_type"),
				 ComponentModelPackage.Literals.DEPENDENCY__DEPEND_OF,
				 true,
				 false,
				 true,
				 null,
